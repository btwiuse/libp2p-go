...
//go:generate sh -c "go run github.com/golang/mock/mockgen -package pstoremanager_test -destination mock_peerstore_test.go github.com/webtransport/libp2p-go/core/peerstore Peerstore"
