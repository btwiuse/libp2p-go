...
manager](https://pkg.go.dev/github.com/webtransport/libp2p-go/core/connmgr#ConnManager),
...
captured in [go-libp2p#1640](https://github.com/webtransport/libp2p-go/issues/1640).
