...
type Identify struct {
	...
	// see github.com/webtransport/libp2p-go/core/record/pb/envelope.proto and
	// github.com/webtransport/libp2p-go/core/peer/pb/peer_record.proto for message definitions.
